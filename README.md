# About this React App
        ...
        Hi Guys, this is a Full CRUD (create, read, update, and delete) application with
        the help of React JS. We have used Redux-Sage to perform all CRUD operations in this
        application. In this application, we have routing facility as well. We have used
